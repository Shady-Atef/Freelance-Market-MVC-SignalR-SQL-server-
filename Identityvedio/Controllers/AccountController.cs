...
namespace Identityvedio.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.UserName, Email = model.Email, Address = model.Address, PhoneNumber = model.PhoneNumber };
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        return RedirectToAction("CreateProfile", "Client");
                    }
                    else
                    {
                        return RedirectToAction("CreateProfile", "Client");
